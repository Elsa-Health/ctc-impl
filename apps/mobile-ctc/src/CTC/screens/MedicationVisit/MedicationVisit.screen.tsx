...
import {UseAppointments} from '../../emr-helpers/react-hooks';
import {
  Block,
  Column,
  ControlDateInput,
...
import {SimpleVisitData as MedicationRequestVisitData} from '@elsa-health/emr/lib/ctc/ctc';
import {CollectionNode} from 'papai/collection/core';
import ARVMedicationItemList from './components/arv-medication-item-list';
...
>({
...
}: WorkflowScreenProps<
  {
    patient: Patient;
    organization: Org;
    initialState?: MedicationRequestVisitData | null;
    visit?: Visit | null;
  },
  {
    complete: (
